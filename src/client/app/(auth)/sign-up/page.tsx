...
const Signup = () => {
  ...
  const onSubmit = async (formData: InputForm) => {
    try {
      ...
      console.log("✅ [SIGN-UP] Signup successful, cart received:", result.cart);
      console.log("✅ [SIGN-UP] Cart items count:", result.cart?.cartItems?.length);
      
      // ✅ Wait for cart cache to invalidate and refetch before redirecting
      // This ensures the cart is updated before the homepage loads
