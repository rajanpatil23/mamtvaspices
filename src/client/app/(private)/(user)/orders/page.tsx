      ...
      <div className="max-w-7xl mx-auto w-full px-3 sm:px-4 py-4 sm:py-8">
        ...
        {isLoading ? (
          ...
          <motion.div
            ...
            transition={{ duration: 0.3 }}
            className="text-center py-12 bg-white rounded-xl shadow-sm border border-gray-200 p-8"
          >
            <div className="max-w-md mx-auto">
              ...
              <Link
                href="/shop"
                className="inline-flex items-center space-x-2 bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-6 rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md"
              >
                <ShoppingBag size={20} />
