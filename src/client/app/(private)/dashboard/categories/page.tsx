...
const CategoriesDashboard = () => {
  ...
  const handleEditPrompt = (category: any) => {
    if (!category) return;
  ...
  const onSubmit = async (formData: CategoryFormData) => {
    ...
    try {
      if (categoryToEdit) {
        ...
        await updateCategory({ id: categoryToEdit.id, categoryData: payload }).unwrap();
      ...
      const errorMessage = err?.data?.message || "Failed to save category";
