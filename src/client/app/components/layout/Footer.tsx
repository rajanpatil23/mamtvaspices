...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-800 to-gray-950 text-white pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="w-full px-8 sm:px-12 lg:px-16 xl:px-20 2xl:max-w-7xl 2xl:mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-12 mb-16 pb-16 border-b border-gray-800/80">
          {/* Logo and description */}
          <div className="col-span-1 lg:col-span-2">
            <div className="flex items-center">
              <Image
                src="/assets/MamtvaSpices Logo.svg"
                alt="Mamtva Spices"
                width={160}
                height={60}
            ...
            <p className="text-gray-400 mt-6 text-sm leading-relaxed">
              Discover authentic Indian spices at Mamtva Spices. Shop with
              confidence and enjoy premium quality spices tailored just for you.
            ...
            <div className="mt-8 flex flex-col space-y-4">
              ...
              <div className="flex items-center">
                <Mail
                  ...
                  className="text-indigo-400 mr-3 flex-shrink-0"
                />
                <p className="text-sm text-gray-400">support@mamtvaspices.com</p>
              </div>
            </div>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row text-center md:text-left items-center space-y-2 md:space-y-0 md:space-x-8 text-sm">
            <p className="text-gray-400">
              © {currentYear} Mamtva Spices. All rights reserved.
            </p>
