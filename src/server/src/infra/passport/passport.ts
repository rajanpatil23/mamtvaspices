...
export default function configurePassport() {
  ...
  if (process.env.FACEBOOK_APP_ID && process.env.FACEBOOK_APP_SECRET) {
    ...
    console.warn("⚠️  Facebook OAuth credentials not set — Facebook login will not work.");
  }

  // Twitter Strategy - only configure if credentials are provided
  if (process.env.TWITTER_CONSUMER_KEY && process.env.TWITTER_CONSUMER_SECRET) {
    ...
    console.warn("⚠️  Twitter OAuth credentials not set — Twitter login will not work.");
  }
}
